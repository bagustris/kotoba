const CACHE_VERSION = 'kotoba-v30';
...
const CORE_ASSETS = [
  ...
  'data/words/life-story.json',
  'data/sentences/life-story.json',
  'data/words/life-events.json',
  'data/sentences/life-events.json',
  'data/words/errands.json',
